    ...
    <div class="col-lg ml-2 p-4">
        <form action="<?= base_url('User/hasilSearch'); ?>" method="GET" class="form-inline mb-4">
            <div class="form-group">
                <input type="search" value="<?= isset($keyword) ? $keyword : '' ?>" name="keyword" autofocus autocomplete="off" class="form-control bg-grey border small" style="width: 800px;" placeholder="Cari Nama Dosen" aria-label="Search" aria-describedby="basic-addon2">
            </div>
